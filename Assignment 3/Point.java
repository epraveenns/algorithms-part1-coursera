...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        double v = that.y - this.y;
        double v1 = that.x - this.x;
        return v / v1;
    ...
    public Comparator<Point> slopeOrder() {
        ...
        Comparator<Point> comparator = ((o1, o2) -> {
            ...
            return Double.compare(this.slopeTo(o1), this.slopeTo(o2));
        });
        return comparator;
    }
    ...
    public static void main(String[] args) {
        /* YOUR CODE HERE */
        Point point =  new Point(2682, 14118);
        Point point1 = new Point(5067, 14118);
        Point point2 = new Point(7453, 14118);
        Point point3 = new Point(7821, 14118);

        double x = point.slopeTo(point1);
        System.out.println(x);
        double x1 = point.slopeTo(point2);
        System.out.println(x1);
        double x2 = point.slopeTo(point3);
        System.out.println(x2);

        System.out.println(Double.compare(x, x1));
        System.out.println(Double.compare(x, x2));
    }
}